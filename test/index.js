...
suite( 'vCard', function() {
  ...
  suite( 'instance', function() {
    ...
    suiteSetup( 'parse', function() {
      var data = fs.readFileSync( __dirname + '/data/vcard-2.1.vcf' )
    ...
    test( 'version number', function() {
      assert.strictEqual( card.version, '2.1' )
      assert.strictEqual( card.get( 'version' ).valueOf(), '2.1' )
    })
  ...
  suite( 'instance', function() {
    ...
    test( 'version number', function() {
      assert.strictEqual( card.version, '3.0' )
      assert.strictEqual( card.get( 'version' ).valueOf(), '3.0' )
    })

    test( 'name', function() {
      assert.strictEqual( card.get( 'n' ).valueOf(), 'Gump;Forrest;;Mr.' )
    })
  ...
  suite( 'instance', function() {
    ...
    suiteSetup( 'parse', function() {
      var data = fs.readFileSync( __dirname + '/data/vcard-LF.vcf' )
      card = new vCard().parse( data )
    })
